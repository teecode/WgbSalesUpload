...
namespace WgbSalesUpload.CRUD
{
    public class shop_type_crud
    {
        ...
        public shop_type_crud(shop_type shop_type_)
        {
            this.shop_type_ = shop_type_;
        }

        public shop_type_crud()
        {
            // TODO: Complete member initialization
        }

        public List<shop_type> getallShopType()
        {
            return db.shop_types.ToList<shop_type>();
        }
