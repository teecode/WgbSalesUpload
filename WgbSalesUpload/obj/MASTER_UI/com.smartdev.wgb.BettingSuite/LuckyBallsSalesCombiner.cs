...
{
    public class LuckyBallsSalesCombiner
    {
        private List<master_luckyballs_sale> _mastersales;
        private List<shop_daily_sale> _shopsales;
        private master_luckyballs_sale _combinedmastersales;
        private shop_daily_sale _combinedshopsales;
        private master_luckyballs_sale _combinedsale;       
        private shop _shop;
        ...
        private decimal msingle_sales, msingle_comm, mmulti_sales, mmulti_comm, msingle_percent;
          ...
          public LuckyBallsSalesCombiner( List<master_luckyballs_sale> mastersales ,List<shop_daily_sale> shopsales, shop shop)
         {
          ...
          public LuckyBallsSalesCombiner(List<master_luckyballs_sale> mastersales, shop shop) : this(mastersales,null,shop)
          {

          
          }
         
        public master_luckyballs_sale combinedsale
          {
          ...
          public master_luckyballs_sale combinedmastersales
          {
          ...
          public List<master_luckyballs_sale> mastersales
          {
