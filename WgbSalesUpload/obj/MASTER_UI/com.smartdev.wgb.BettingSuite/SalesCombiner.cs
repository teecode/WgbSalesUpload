...
namespace WgbSalesUpload.MASTER_UI.com.smartdev.wgb.BettingSuite
{
    public class SalesCombiner
    {
        ...
        private List<master_daily_sale> _mastersales;
        private List<shop_daily_sale> _shopsales;
        private master_daily_sale _combinedmastersales;
        private shop_daily_sale _combinedshopsales;
        private master_daily_sale _combinedsale;       
        private shop _shop;
        ...
        private decimal msingle_sales, msingle_comm, mmulti_sales, mmulti_comm, msingle_percent;
          ...
          public SalesCombiner( List<master_daily_sale> mastersales ,List<shop_daily_sale> shopsales, shop shop)
         {
          ...
          public SalesCombiner(List<master_daily_sale> mastersales, shop shop) : this(mastersales,null,shop)
          {

          
          }
         
        public master_daily_sale combinedsale
          {
          ...
          public master_daily_sale combinedmastersales
          {
          ...
          public List<master_daily_sale> mastersales
          {
